...
{
    /**
     * @return float The (Slack) timestamp on which the latest action was performed on the channel.
     */
    ...
    /**
     * @return float The (Slack) timestamp on which the first action was performed on the channel.
     */
    public function getOldest()
    {
        return $this->data['oldest'];
    }
    ...
    protected function configureResolver(OptionsResolverInterface $resolver)
    {
        ...
        $resolver->setAllowedTypes([
            'latest'   => ['float', 'null'],
            'oldest'   => ['float', 'null'],
            'messages' => ['array<\CL\Slack\Model\SimpleMessage>'],
            'has_more' => ['bool'],
        ]);
